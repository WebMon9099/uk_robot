                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn btn-outline-primary btn-sm edit-btn"
                                            ...
                                            data-social-links="{{ json_encode($blog->social_links) }}"
                                            data-bs-toggle="modal" data-bs-target="#editBlogModal">
                                            <i class="fa fa-edit m-0"></i>
                                        </button>
                                        <form action="{{ route('press.destroy', $blog->id) }}" method="POST"
                ...
                <div class="modal-body">
                    <form id="addBlogForm" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="file" class="form-control" name="blog_images[]" id="blog_image" required multiple>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="url" name="social_links[instagram]" class="form-control" id="instagram">
                        </div>
                        <div class="mb-3">

                            <label for="linkedin" class="form-label">LinkedIn</label>
                            <input type="url" name="social_links[linkedin]" class="form-control" id="linkedin">
                        </div>
                        <div class="mb-3">
                            <label for="facebook" class="form-label">Facebook</label>
                            <input type="url" name="social_links[facebook]" class="form-control" id="facebook">
                        </div>
                        <div class="mb-3">
                            <label for="twitter" class="form-label">Twitter</label>
                            <input type="url" name="social_links[twitter]" class="form-control" id="twitter">
                        </div> -->
                    ...
                    <form id="editBlogForm" enctype="multipart/form-data" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3" style="display: flex; flex-direction: column;">
                                ...
                                <img id="currentBlogImage" src="" alt="No Image Available"
                                    class="img-fluid avatar-sm rounded mb-2" style="height: 5rem; width:7rem">
                            </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <small class="form-text text-muted">Upload up to 10 MB per image. Accepted formats: JPEG,
                                    PNG, JPG, GIF.</small>

...
@section('main_section')
                ...
                <div class="modal-body">
                    <form id="editBlogForm" enctype="multipart/form-data" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                <label for="editBlogImage" class="form-label">Upload New Images</label>
                                <input class="form-control" id="editBlogImage" name="blog_image[]" type="file" multiple>
    ...
    function initTinyMCE(selector) {
        tinymce.init({
            ...
            // Image upload setup
            images_upload_url: '/your-upload-url', // Replace with your upload endpoint
            ...
            file_picker_callback: function (cb, value, meta) {
                if (meta.filetype === 'image') {
                    ...
                    input.onchange = function () {
                        ...
                        fetch('/your-upload-url', { // Replace with your upload endpoint
                            method: 'POST',
                            body: formData
                        })
    ...
    // Initialize for multiple textareas
    initTinyMCE('description');
    initTinyMCE('editDescription');
</script> --}}

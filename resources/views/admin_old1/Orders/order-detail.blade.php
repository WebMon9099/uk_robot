                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        @foreach ($order->orderItems as $item)
                            <div class="card">
                                <div class="card-header pt-3">
                                    <form action="{{ route('order.changeOrderSatatus', $item->id) }}" method="post"
                                        name="changeOrderStatus" id="changeOrderStatus">
                                        @csrf
                                        <div class="row">
                                            <div class="col-md-8">
                                                <div class="card mb-4 shadow-sm">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="row mb-3 align-items-center">
                                                            <div class="col-md-4">
                                                                <strong class="fs-5"><i class="bi bi-tag me-2"></i>Product
                                                                    Name:</strong>
                                                            </div>
                                                            <div class="col-md-8">
                                                                <span
                                                                    class="h6 text-primary">{{ $item->product_name }}</span>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row mb-3 align-items-center">
                                                            <div class="col-md-4">
                                                                <strong class="fs-5"><i
                                                                        class="bi bi-stack me-2"></i>Pallet Of:</strong>
                                                            </div>
                                                            <div class="col-md-8">
                                                        ...
                                                        <div class="row mb-3 align-items-center">
                                                            <div class="col-md-4">
                                                                <strong class="fs-5"><i
                                                                        class="bi bi-collection me-2"></i>Quantity:</strong>
                                                            </div>
                                                            <div class="col-md-8">
                                                        ...
                                                        <div class="row mb-3 align-items-center">
                                                            <div class="col-md-4">
                                                                <strong class="fs-5"><i
                                                                        class="bi bi-cash me-2"></i>Price:</strong>
                                                            </div>
                                                            <div class="col-md-8">
                                                                <span
                                                                    class="h6 text-primary">${{ number_format($item->price, 2) }}</span>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row mb-3 align-items-center">
                                                            <div class="col-md-4">
                                                                <strong class="fs-5"><i
                                                                        class="bi bi-tags me-2"></i>Status:</strong>
                                                            </div>
                                                            <div class="col-md-8">
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text" name="delivery_partner"
                                                                    id="delivery_partner" class="form-control"
                                                                    value="{{ $item->delivery_partner ? $item->delivery_partner : '' }}">
                                                            </div>
                                                            <div class="mb-3">
                                                                <label>Tracking Number</label>
                                                                <input type="text" name="tracking_number"
                                                                    id="tracking_number" class="form-control"
...
@section('customeJs')
    <script>
        ...
        // });
        $(document).ready(function() {
            $('form[name="changeOrderStatus"]').on('submit', function(event) {
                event.preventDefault(); // Prevent default form submission

                // Display loading state or message
                $(this).find('button[type="submit"]').text('Updating...').prop('disabled', true);
                ...
                $.ajax({
                    ...
                    error: function(xhr) {
                        ...
                        $(this).find('button[type="submit"]').text('Update').prop('disabled',
                            false);
                    }
                });
            });

<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
  <div class="app-brand demo">
    <a href="{{ route('dashboard') }}" class="app-brand-link">
      <span class="app-brand-logo demo">
        <img src="{{ asset('images/logo.png') }}" alt="logo.png" style="object-fit: cover; border-radius: 8px; max-height: 60px; padding-bottom:5px;">
      </span>
  ...
  <ul class="menu-inner py-1">
    ...
    <!-- Account Settings -->
    <li class="menu-item {{ request()->routeIs('user.index', 'payment.index', 'site.setting') ? 'active' : '' }}">

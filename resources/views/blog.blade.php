                    ...
                    <div class="mb-1" style="flex: 1;display:flex">
                        ...
                        <div class="mx-2">
                            <a href="tel:03333553600"
                                style="color: #f0f0f0; text-decoration: none; font-size: 1rem;">Phone: 0333 355 3600</a>
                            <br>
                            <a href="tel:07976826004"
                                style="color: #f0f0f0; text-decoration: none; font-size: 1rem;">Mobile: 07976 826004</a>
                        </div>
                        </p>
                    </div>
            ...
            const loadBlogs = async () => {
                try {
                    ...
                    if (newBlogs.length === 0) {
                        loadingIndicator.textContent = "No Blogs";
                        observer.disconnect();
                    }
                } catch (error) {
                    console.error(error);

...
@section('main_section')
    <div class="position-relative text-white"
        ...
        <div class="container-fluid py-5 h-100" style="position: relative; z-index:2;">
            <div class="row justify-content-center" style="height:10%">
                <div class="col-md-12 text-center">
                    <h3 class="frgtpswd">For Press/Blog Register Here!</h3>
                                ...
                                <div class="position-relative container py-1 mx-auto">
                                    ...
                                    <div class="step" id="step8" style="display: none;">
                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            <small id="usertypeError" class="form-text fw-bold fs-6 text-black" style="display: none;">Please Select your Type</small>
                                        </div>
                                        <button type="button" class="btn btn-warning btn-lg"
                                    ...
                                    <button id="loginButton" class="btn btn-warning btn-lg" style="display:none;">Go to Login</button>
            ...
            $(document).ready(function() {
                ...
                $('#typeNext').click(function () { 
                    ...
                    if (userType === '' || userType === null) {
                        ...
                        /* Uncomment and adjust if needed for step9 behavior
                        $('#step9').show();
                        var orderText = `Ok, I think I got that. Thank you. So you’d like to buy some ROBOT KOMBUCHA - that’s great. In order to direct your purchase to the right team, I just need to ask a couple more questions.`;
                ...
                $('#submitOrder').click(function() {
                    ...
                    // Basic validation
                    if (firstName === '' || email === '' || phoneNumber === '' || password === '' || selectedRole === '' ) {
                    ...
                    var fullName = firstName + ' ' + lastName;
                    $.ajax({
                        url: '/blog-register', // Adjust the URL based on your route
                        method: 'POST',
                        data: {
